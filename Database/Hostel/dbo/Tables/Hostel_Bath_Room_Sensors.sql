CREATE TABLE [dbo].[Hostel_Bath_Room_Sensors]
(
    ...
    CONSTRAINT [FK_Hostel_Bath_Room_Sensors_Bathroom] FOREIGN KEY ([BathRoomId]) REFERENCES [dbo].[Hostel_Bath_Room] ([BathRoomId]),
